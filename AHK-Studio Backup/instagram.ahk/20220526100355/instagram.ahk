...
Instagram_Helper_UnfollowPerson(person){
	...
	isUnfollow :="|<>*179$71.zzzzlszzzzzy0TzzXlzzzzzw0zzz7Xzzzzzs1zzyD7zzzzznzzzwSDzzzzzbzzzswTzzzzzDzkDlsz0S7XsTy0DXlw0QD3Uzs8D7XkEQS701lwCD73sssC033wQSCDkkkQ0CDsswQTVlYFDwTllskz3W8WTszXXlly74F4zkz77XXwS1m9zlwCD73sy3UnzUUwSD31w71bzU3swS07sC3DzUDlsz0zsyD"
	
	if (ok:=FindText(X:="wait", Y:=10, 1336-150000, 293-150000, 1336+150000, 293+150000, 0, 0, isUnfollow))
	{
		Notify("Instagram","Unfollowed!",1)
	}
}
