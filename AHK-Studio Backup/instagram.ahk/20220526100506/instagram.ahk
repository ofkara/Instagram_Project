...
Instagram_Helper_UnfollowPerson(person){
	...
	if (ok:=FindText(X:="wait", Y:=10, 1142-150000, 293-150000, 1142+150000, 293+150000, 0, 0, request_button))
	{
	...
	if (ok:=FindText(X:="wait", Y:=10, 1315-150000, 293-150000, 1315+150000, 293+150000, 0, 0, man_button))
	{
		FindText().Click(X, Y, "L")
