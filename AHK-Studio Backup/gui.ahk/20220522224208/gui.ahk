...
if(edit_UnfollowRate > edit_UnfollowNumber){
	...
	if(hour_unfollow > 1){
		GuiControl,, text_Unfollow, Follow %edit_UnfollowNumber% people in %hour_unfollow% hours
	}else{
		GuiControl,, text_Unfollow, Follow %edit_UnfollowNumber% people in %hour_unfollow% hour
	}
}
