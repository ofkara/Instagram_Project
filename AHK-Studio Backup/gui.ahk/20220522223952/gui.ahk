...
Gui Add, Text, vtext_Follow x63 y152 w331 h23 +0x200 +0x1, Follow x people in 1 hour
Gui Add, Text, vtext_Unfollow x62 y176 w333 h23 +0x200 +0x1, Unfollow x people in 1 hour
...
if(edit_followRate > edit_FollowNumber){
	...
	hour := Round((edit_FollowNumber / edit_followRate),0)
	if(hour > 1){
		GuiControl,, text_Follow, Follow %edit_FollowNumber% people in %hour% hours
	}else{
		GuiControl,, text_Follow, Follow %edit_FollowNumber% people in %hour% hour
	}
